...
- [x] **Enable weights** — **Done**. Full catalog built from 11,501 symbols on research droplet (~35 hrs): 34,890 motif keys, 56.2M observations, 6,114 passing inclusion threshold. Weights differentiated by strategy: baseline 10x, MR 25x. Capitulation motifs naturally align with MR (50% of MR candidates get curve scores) but fight against baseline trend indicators. At 25x, strong MR motif matches contribute 2-6 points. Top motif `D2S:D1S:D4M_40` (staircase decline) has 80% win rate vs 37% baseline. 10-bar windows tested and rejected — too few bars for 3-segment signatures (70% degenerate to 1-2 segments).
