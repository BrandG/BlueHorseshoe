"""SMA distance-band v1 rerun under v2 methodology."""
...
def main():
    ...
    out_dir = "/root/BlueHorseshoe/research/_v2_rerun/sma"
    os.makedirs(out_dir, exist_ok=True)
    print(f"=== SMA-band v2 walk-forward (entry={entry_mode}) ===\n", flush=True)
    all_rows = []
    t0 = time.time()
    ...
    print(f"\n=== SMA-band v2 spread test (entry={entry_mode}) ===", flush=True)
    spread_rows = []
