"""Walk-forward 70/30 split for the CCI trigger sweep. Mid prices."""
...
def main():
    out_path = "/root/BlueHorseshoe/research/cci_phase0_v1/walkforward_cci_triggers.csv"
    ...
    print("\n=== Top 30 'both halves CI>50%' cells by test WR ===")
    top = surv_both.sort_values("te_wr", ascending=False).head(30)
