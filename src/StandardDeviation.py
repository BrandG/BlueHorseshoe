...
#     Example:
#         print(calculate_stability_score(load_historical_data('QGEN')['days'][:40]))
#         print(calculate_stability_score(load_historical_data('IBM')['days'][:40]))
#         print(calculate_stability_score(load_historical_data('A')['days'][:40]))
...
#     Usage:
#         analyze_symbol_stability([item['symbol'] for item in get_symbol_list()])
