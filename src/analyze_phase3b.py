#!/usr/bin/env python3
"""
Phase 3B Results Analysis

Analyzes backtest results for Phase 3B indicators by matching CSV dates
against test log to determine which indicator/weight was being tested.
"""
...
def generate_summary_report(results_df):
    ...
    print("\n" + "="*80)
    print("PHASE 3B RESULTS SUMMARY")
    print("="*80)
...
def main():
    print("\n" + "#"*80)
    print("# PHASE 3B RESULTS ANALYSIS")
    print("#"*80)
    print()
    ...
    output_file = 'src/logs/phase3b_analysis.csv'
