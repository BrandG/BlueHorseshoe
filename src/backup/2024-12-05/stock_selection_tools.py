...
#     Usage:
#         print(get_rolling_close_open_delta_percentage(price_data = load_historical_data('QGEN')['days']))
#     """
...
#     usage:
#         print(get_weighted_price_stability(price_data = load_historical_data('QGEN')['days']))
#     """
...
#     Usage:
#     print(get_MATR_stability(price_data=load_historical_data('QGEN')['days']))
